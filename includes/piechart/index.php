...
<body>
	<div id="pie">
		...
		<img src= "../includes/piechart/loadb.gif" alt="loading…" id="spinner" />
	</div>
	<form action="#no_javascript-no_fun" id="pie-form">
        ...
        <?php if ($teacher == 1){?>
				<button type="button" id="perc">
					<img src="../includes/piechart/percent.png" alt="Percentage view on/off" title="percentage view on/off" />
				</button>
				<?php } ?>
